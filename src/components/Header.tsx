      ...
      <div className="container mx-auto px-4">
        ...
        {isMenuOpen && (
          <nav className="md:hidden py-4 space-y-2 animate-slide-up">
            <button onClick={() => scrollToSection("home")} className="block w-full text-left px-4 py-2 text-foreground hover:bg-secondary rounded-lg transition-smooth">
              Home
            </button>
            <button onClick={() => scrollToSection("about")} className="block w-full text-left px-4 py-2 text-foreground hover:bg-secondary rounded-lg transition-smooth">
              About
            </button>
            <button onClick={() => scrollToSection("consultation")} className="block w-full text-left px-4 py-2 text-foreground hover:bg-secondary rounded-lg transition-smooth">
              Consult Doctor
            </button>
            <button onClick={() => scrollToSection("blog")} className="block w-full text-left px-4 py-2 text-foreground hover:bg-secondary rounded-lg transition-smooth">
              Articles
            </button>
